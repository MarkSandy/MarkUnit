...
{
    internal class AssemblyRule : RuleBase<IAssembly,IAssemblyTestCondition,IAssemblyRule>, IInternalAssemblyTestCondition
    { 
        public AssemblyRule(IFilter<IAssembly> items, bool negateAssertion) : base(items, negateAssertion)
        {
